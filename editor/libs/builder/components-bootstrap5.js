Rigel.ComponentsGroup['Bootstrap 5'] =
...
Rigel.Components.extend("_base", "html/btn", {
...
Rigel.Components.extend("_base", "html/card", {
    ...
    name: "Card",
    html: '<div class="card">\
		  <img class="card-img-top" src="' +  Rigel.baseUrl + 'icons/image.svg" alt="Card image cap" width="128" height="128">\
		  <div class="card-body">\
