...
Rigel.Sections.add("bootstrap4/signin-split", {
    name: "Modern Sign In Page with Split Screen Format",
	dragHtml: '<img src="' + Rigel.baseUrl + 'icons/product.png">',    
...
Rigel.Sections.add("bootstrap4/image-gallery", {
    name: "Image gallery",
...
Rigel.Sections.add("bootstrap4/slider-header", {
...
Rigel.Sections.add("bootstrap4/video-header", {
    name: "Video Header",
	dragHtml: '<img src="' + Rigel.baseUrl + 'icons/image.svg">',        
...
Rigel.Sections.add("bootstrap4/about-team", {
...
Rigel.Sections.add("bootstrap4/portfolio-one-column", {
...
Rigel.Sections.add("bootstrap4/portfolio-two-column", {
...
Rigel.Sections.add("bootstrap4/portfolio-three-column", {
...
Rigel.Sections.add("bootstrap4/portfolio-four-column", {
