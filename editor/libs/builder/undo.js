	...
	*/	
	addMutation : function(mutation) {	
		/*
			...
			this.undoIndex++;
		*/
		Rigel.Builder.frameBody.trigger("rigel.undo.add");
	...
	restore : function(mutation, undo) {	
		...
		switch (mutation.type) {
			...
			case 'characterData':
			  ...
			  break;
			case 'style':
			  $("#rigeljs-styles", window.FrameDocument).html( undo ? mutation.oldValue : mutation.newValue );
			  break;
			case 'attributes':
		...
		Rigel.Builder.frameBody.trigger("rigel.undo.restore");
	 },
