...
Rigel.ComponentsGroup['Server Components'] = ["components/products", "components/product", "components/categories", "components/manufacturers", "components/search", "components/user", "components/product_gallery", "components/cart", "components/checkout", "components/filters", "components/product", "components/slider"];


Rigel.Components.add("components/product", {
    name: "Product",
...
Rigel.Components.add("components/products", {
    name: "Products",
...
Rigel.Components.add("components/manufacturers", {
    name: "Manufacturers",
...
Rigel.Components.add("components/categories", {
    name: "Categories",
...
Rigel.Components.add("components/search", {
    name: "Search",
...
Rigel.Components.add("components/user", {
    name: "User",
...
Rigel.Components.add("components/product_gallery", {
...
Rigel.Components.add("components/cart", {
    name: "Cart",
...
Rigel.Components.add("components/checkout", {
    name: "Checkout",
...
Rigel.Components.add("components/filters", {
    name: "Filters",
...
Rigel.Components.add("components/slider", {
    name: "Slider",
