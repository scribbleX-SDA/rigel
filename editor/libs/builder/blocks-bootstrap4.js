...
Rigel.Blocks.add("bootstrap4/product-card", {
...
Rigel.Blocks.add("bootstrap4/user-online", {
    name: "User online",
...
Rigel.Blocks.add("bootstrap4/our-team", {
    name: "Our team",
...
Rigel.Blocks.add("bootstrap4/login-form", {
    name: "Login form",
...
Rigel.Blocks.add("bootstrap4/about-team", {
...
Rigel.Blocks.add("bootstrap4/pricing-1", {
    name: "Pricing table",
...
Rigel.Blocks.add("bootstrap4/loading-circle", {
    name: "Loading circle",
...
Rigel.Blocks.add("bootstrap4/block-quote", {
    name: "Block quote",
...
Rigel.Blocks.add("bootstrap4/subscribe-newsletter", {
