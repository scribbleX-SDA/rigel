...
Rigel.ComponentsGroup['Bootstrap 4'] =
...
//display
Rigel.Components.extend("_base", "_base", {
	 properties: [
     {
        key: "display_header",
        inputtype: SectionInput,
...
Rigel.Components.extend("_base", "html/container", {
...
Rigel.Components.extend("_base", "html/heading", {
...
Rigel.Components.extend("_base", "html/link", {
    nodes: ["a"],
    name: "Link",
...
Rigel.Components.extend("_base", "html/image", {
    nodes: ["img"],
    name: "Image",
    html: '<img src="' +  Rigel.baseUrl + 'icons/image.svg" height="128" width="128">',
    /*
...
Rigel.Components.add("html/hr", {
    image: "icons/hr.svg",
    nodes: ["hr"],
    name: "Horizontal Rule",
    html: "<hr>"
});
Rigel.Components.extend("_base", "html/label", {
    name: "Label",
    nodes: ["label"],
...
Rigel.Components.extend("_base", "html/button", {
...
Rigel.Components.extend("_base", "html/buttongroup", {
    classes: ["btn-group"],
    name: "Button Group",
...
Rigel.Components.extend("_base", "html/buttontoolbar", {
    classes: ["btn-toolbar"],
    name: "Button Toolbar",
...
Rigel.Components.extend("_base","html/alert", {
    classes: ["alert"],
    name: "Alert",
...
Rigel.Components.extend("_base", "html/badge", {
    classes: ["badge"],
...
Rigel.Components.extend("_base", "html/card", {
    classes: ["card"],
...
Rigel.Components.extend("_base", "html/listgroup", {
    name: "List Group",
    image: "icons/list_group.svg",
    classes: ["list-group"],
    html: '<ul class="list-group">\n  <li class="list-group-item">\n    <span class="badge">14</span>\n    Cras justo odio\n  </li>\n  <li class="list-group-item">\n    <span class="badge">2</span>\n    Dapibus ac facilisis in\n  </li>\n  <li class="list-group-item">\n    <span class="badge">1</span>\n    Morbi leo risus\n  </li>\n</ul>'
});
Rigel.Components.extend("_base", "html/listitem", {
    name: "List Item",
    classes: ["list-group-item"],
    html: '<li class="list-group-item"><span class="badge">14</span> Cras justo odio</li>'
});
Rigel.Components.extend("_base", "html/breadcrumbs", {
    classes: ["breadcrumb"],
    name: "Breadcrumbs",
...
Rigel.Components.extend("_base", "html/breadcrumbitem", {
...
Rigel.Components.extend("_base", "html/pagination", {
    classes: ["pagination"],
    name: "Pagination",
...
Rigel.Components.extend("_base", "html/pageitem", {
	classes: ["page-item"],
...
Rigel.Components.extend("_base", "html/progress", {
    classes: ["progress"],
    name: "Progress Bar",
...
Rigel.Components.extend("_base", "html/jumbotron", {
    classes: ["jumbotron"],
...
Rigel.Components.extend("_base", "html/navbar", {
    classes: ["navbar"],
...
Rigel.Components.extend("_base", "html/form", {
    nodes: ["form"],
...
Rigel.Components.extend("_base", "html/textinput", {
    name: "Input",
	nodes: ["input"],
...
Rigel.Components.extend("_base", "html/selectinput", {
	nodes: ["select"],
    name: "Select Input",
		...
		$(node).find('option').each(function() {
			...
			properties.push({
				...
				onChange: function(node, value, input) {
					...
					{
						option.remove();
						Rigel.Components.render("html/selectinput");
						return node;
					}
...
Rigel.Components.extend("_base", "html/textareainput", {
    name: "Text Area",
    image: "icons/text_area.svg",
    html: '<div class="mb-3"><label>Your response:</label><textarea class="form-control"></textarea></div>'
});
Rigel.Components.extend("_base", "html/radiobutton", {
    name: "Radio Button",
...
Rigel.Components.extend("_base", "html/checkbox", {
    name: "Checkbox",
...
Rigel.Components.extend("_base", "html/fileinput", {
    name: "Input group",
...
Rigel.Components.extend("_base", "html/table", {
    nodes: ["table"],
    classes: ["table"],
...
Rigel.Components.extend("_base", "html/tablerow", {
    nodes: ["tr"],
    name: "Table Row",
...
Rigel.Components.extend("_base", "html/tablecell", {
    nodes: ["td"],
    name: "Table Cell",
    html: "<td>Cell</td>"
});
Rigel.Components.extend("_base", "html/tableheadercell", {
    nodes: ["th"],
    name: "Table Header Cell",
    html: "<th>Head</th>"
});
Rigel.Components.extend("_base", "html/tablehead", {
    nodes: ["thead"],
    name: "Table Head",
...
Rigel.Components.extend("_base", "html/tablebody", {
    nodes: ["tbody"],
    name: "Table Body",
    html: "<tbody><tr><td>Cell 1</td><td>Cell 2</td><td>Cell 3</td></tr></tbody>"
});

Rigel.Components.add("html/gridcolumn", {
    name: "Grid Column",
...
Rigel.Components.add("html/gridrow", {
    name: "Grid Row",
    image: "icons/grid_row.svg",
    classes: ["row"],
		...
		$(node).find('[class*="col-"]').each(function() {
			...
			properties.push({
				...
				onChange: function(node, value, input) {
					...
					{
						column.remove();
						Rigel.Components.render("html/gridrow");
						return node;
					}
...
Rigel.Components.extend("_base", "html/paragraph", {
    nodes: ["p"],
    name: "Paragraph",
...
Rigel.Components.extend("_base", "html/video", {
    nodes: ["video"],
    name: "Video",
    ...
    dragHtml: '<img  width="320" height="240" src="' + Rigel.baseUrl + 'icons/video.svg">',
