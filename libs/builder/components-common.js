...
Rigel.Components.extend("_base", "_base", {
	 properties: [
	 {
		...
		afterInit:function(node, inputElement) {
			var selector = Rigel.StyleManager.getSelectorForElement(node);
...
Rigel.Components.extend("_base", "_base", ComponentBaseTypography);
...
Rigel.Components.extend("_base", "_base", ComponentBaseSize);
...
Rigel.Components.extend("_base", "_base", ComponentBaseMargin);
...
Rigel.Components.extend("_base", "_base", ComponentBasePadding);
...
Rigel.Components.extend("_base", "_base", ComponentDeviceVisibility);


Rigel.Components.add("config/bootstrap", {
	...
	beforeInit: function (node) {
		...
		let cssVars = Rigel.ColorPaletteManager.getAllCSSVariableNames(window.FrameDocument.styleSheets, ":root");
				...
				properties.push({
					...
					onChange: function(node, value, input) {
						...
						if (this.data.type == "font") {
							...
							Rigel.FontsManager.addFont(option.dataset.provider, value, node[0]);
						}

						Rigel.StyleManager.setStyle(":root", this.data.selector, value);
