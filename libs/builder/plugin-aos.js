...
$(window).on("rigel.getHtml.after", function(event, doc) {
	$("[data-aos]", doc).addClass("aos-init aos-animate");
});

//ignore aos classes for styles
Rigel.Builder.ignoreClasses = Rigel.Builder.ignoreClasses.concat(["aos-init", "aos-animate"]);
...
Rigel.Components.extend("_base", "_base", ComponentBaseAnimateScroll);
